        ...
        if driverConfig.endswith("phantomjs"):
            ...
            try:
                self.driver = webdriver.PhantomJS(
                    executable_path=os.environ["USERPROFILE"] + os.sep + "drivers" + os.sep + "phantomjs.exe",
            ...
            try:
                self.driver = webdriver.Firefox(
                    executable_path=os.environ["USERPROFILE"] + os.sep + "drivers" + os.sep + "geckodriver.exe",
            ...
            chromedriver = os.environ["USERPROFILE"] + os.sep + "drivers" + os.sep + "chromedriver.exe"
