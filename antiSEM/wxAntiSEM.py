...
class wxAntiSEM(wx.Frame, page):
    ...
    def controllers(self):
        ...
        self.multiText1.SetBackgroundColour('#AFAF61')
        ...
        self.multiText2.SetBackgroundColour('#AFAF61')
        ...
        self.multiText3.SetBackgroundColour('#AFAF61')
        ...
        self.multiText4.SetBackgroundColour('#AFAF61')
        ...
        self.multiText5.SetBackgroundColour('#AFAF61')
        ...
        self.multiText6.SetBackgroundColour('#AFAF61')
